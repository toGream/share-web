<template>
	<div id="container">
		...
		<div id="main_right">
			<div class="right_hot">
				<div class="hot_content_item" v-for="content in hotContents">
					<ul class="hot_img">
						<li>
